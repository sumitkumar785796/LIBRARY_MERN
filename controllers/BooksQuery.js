...
const viewSinglebookRecords = async (req,res) =>{
    try {
        const {id}=req.params
        const viewQuery = "select book_name , department, class as student_class from books where book_id=?"
...
const totalBooksRecord = async (req,res)=>{
    try {
...
module.exports={insertbookRecord,viewbookRecords,viewSinglebookRecords,updateBookRecord,deleteBookRecord,totalBooksRecord}